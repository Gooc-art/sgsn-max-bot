...
- Главное меню: `Выгрузка за неделю`, `Выбрать период`, `Статус выгрузки`, `Отмена`.
- Выбор периода: `Текущая неделя`, `Прошлая неделя`, `Свой период`, `Назад`, `Главное меню`.
- Выбор суда: `Все суды`, отдельные суды ЯНАО, `Назад`, `Главное меню`.
